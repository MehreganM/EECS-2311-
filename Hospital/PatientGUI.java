    ...
    public PatientGUI(Physician loggedInPhysician,Hospital hospital) {
    	  this.hospital = hospital;
    	    ...
    	    prescribeMedicationButton.addActionListener(new ActionListener() {
    	        public void actionPerformed(ActionEvent e) {
    	            PrescriptionGUI prescriptionGUI = new PrescriptionGUI(loggedInPhysician, hospital);
		...
		DisplayPatients.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				patientInfoArea.append(dataOps.getPatientByPhysicianId(dataOps.getPhysicianIdByName(loggedInPhysician.getFirstName(), loggedInPhysician.getLastName())));
			}
		});
		...
		getPatientByID.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				patientInfoArea.setText("");
				patientInfoArea.append(dataOps.getPhysPatientById(patientId,dataOps.getPhysicianIdByName(loggedInPhysician.getFirstName(), loggedInPhysician.getLastName())));
			}
		});
		...
		getPatientByName.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				patientInfoArea.setText("");
				patientInfoArea.append(dataOps.searchPhysPatientsByName(name,dataOps.getPhysicianIdByName(loggedInPhysician.getFirstName(), loggedInPhysician.getLastName())));
			}
		});
